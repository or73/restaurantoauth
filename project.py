...
def fbconnect():
    ...
    print('1. app_id: ', app_id)
    print('2. app_secret: ', app_secret)
...
def newRestaurant():
    """
    Create a new restaurant
    :return: if POST requirement then 'redirecto' to a 'showRestaurants' URL
            else return 'render_template', to 'newRestaurant.html'
    """
    if 'username' not in login_session:
